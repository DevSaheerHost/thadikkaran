...
// Walk-in marker on manually added bookings
const WALKIN_ICON =
  `<svg class="walkin-icon" viewBox="0 0 640 640" fill="currentColor" aria-hidden="true">` +
...
function buildBookingCard(item) {
  ...
  const sourceSticker = item.source === "admin"
    ? `<div class="booking-manual-sticker">${WALKIN_ICON}Walk-in</div>` : "";
